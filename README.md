...
Vercel 배포 주소: https://dnf.land (갑자기 로그인에 문제가 생겼습니다)
...
이외에도 개발 과정 중에 여러 문제들을 정말 많이 마주쳤습니다.

그럴 때마다 문제의 원인을 파악하고 해결하면서 공부가 되었고 프레임워크를 조금 더 잘 이해할 수 있었습니다.

그리고 해결 방안을 찾을 수 없던 문제를 모듈 버전을 낮춘 것만으로 해결하는 등 문제의 원인은 여러가지가 있을 수 있다는 것을 배웠습니다.

개발이라는 일이 코드 작성이 전부가 아니고 에러나 문제를 해결하는 데 많은 시간을 쓰는 일이라는 것을 직접 경험했습니다.
...
프로젝트를 진행하면서 기술적인 측면과 개발이라는 직무에 대한 측면에서 많은 것을 배울 수 있었습니다.
