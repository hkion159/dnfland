...
// EXTERNAL MODULE: ./styles/homebox.module.css
var homebox_module = __webpack_require__(73355);
var homebox_module_default = /*#__PURE__*/__webpack_require__.n(homebox_module);
...
;// CONCATENATED MODULE: ./lib/date.js
...
;// CONCATENATED MODULE: ./components/box/homebox.js
...
function Homebox({
  ...
  var _adventure$characters;

  const [session, loading] = (0,client/* useSession */.kP)(); // 건의하기 //
  ...
  const enrollRef = (0,react.useRef)(null);
  const {
    0: enroll,
    1: setEnroll
  } = (0,react.useState)(false);
  const onEnroll = (0,react.useCallback)(e => {
    setEnroll(true);
    setTimeout(() => {
      setEnroll(false);
    }, 1500);
  ...
  }, [session === null || session === void 0 ? void 0 : session.id]); // 모험단 조회 //
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: (homebox_module_default()).container,
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: `${(homebox_module_default()).introduce} d-flex flex-column`,
      children: [/*#__PURE__*/jsx_runtime.jsx("div", {
        className: "py-3 px-4 text-end",
        children: `회원 수: ${maxId}명`
      }), /*#__PURE__*/jsx_runtime.jsx("h3", {
        children: "\uB358\uD30C\uB79C\uB4DC\uC5D0 \uC624\uC2E0 \uAC83\uC744 \uD658\uC601\uD569\uB2C8\uB2E4."
      }), /*#__PURE__*/jsx_runtime.jsx("h5", {
        children: "\uD604\uC7AC \uC0AC\uC774\uD2B8 \uAC1C\uBC1C \uC911\uC5D0 \uC788\uC73C\uBA70 \uB370\uBBF8\uC9C0 \uACC4\uC0B0 \uB85C\uC9C1\uC740 \uC544\uC9C1 \uBBF8\uAD6C\uD604 \uC0C1\uD0DC\uC785\uB2C8\uB2E4."
      }), !session && /*#__PURE__*/jsx_runtime.jsx("h5", {
        children: "\uB85C\uADF8\uC778\uD558\uACE0 \uBAA8\uD5D8\uB2E8\uC744 \uB4F1\uB85D\uD558\uBA74 \uD648\uC5D0\uC11C \uBC14\uB85C \uC811\uADFC\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4."
      }), session && (adventure ? /*#__PURE__*/jsx_runtime.jsx("div", {
        ...
        children: (adventure === null || adventure === void 0 ? void 0 : (_adventure$characters = adventure.characters) === null || _adventure$characters === void 0 ? void 0 : _adventure$characters.length) === 0 ? /*#__PURE__*/jsx_runtime.jsx("p", {
        ...
        }), enroll && /*#__PURE__*/jsx_runtime.jsx("p", {
          className: "text-success my-3",
          children: "\uB4F1\uB85D\uB418\uC5C8\uC2B5\uB2C8\uB2E4!!"
        })]
      }))]
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: (homebox_module_default()).infos,
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: (homebox_module_default()).f1,
        children: [/*#__PURE__*/jsx_runtime.jsx("div", {
          ...
          children: /*#__PURE__*/jsx_runtime.jsx(next_link.default, {
            ...
            children: /*#__PURE__*/jsx_runtime.jsx("a", {
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)("h5", {
                ...
                children: ["\uB358\uD30C\uB79C\uB4DC\uC18C\uC2DD", /*#__PURE__*/jsx_runtime.jsx("svg", {
        ...
        children: [/*#__PURE__*/jsx_runtime.jsx("h5", {
          ...
          className: "input-group py-3 px-4",
          onSubmit: onSubmit,
          children: [/*#__PURE__*/jsx_runtime.jsx("input", {
            type: "text",
        ...
        }), submit && /*#__PURE__*/jsx_runtime.jsx("p", {
          className: "mx-3 my-1 text-success",
          style: {
            fontSize: '8'
          },
          children: "\uC804\uC1A1\uB418\uC5C8\uC2B5\uB2C8\uB2E4!"
...
/* harmony default export */ const homebox = (Homebox);
...
var _prisma_client = __webpack_require__(930);
;// CONCATENATED MODULE: ./lib/prisma.js

let prisma;

if (true) {
  prisma = new _prisma_client.PrismaClient();
} else {}
...
function Home({
  ...
  return /*#__PURE__*/jsx_runtime.jsx(jsx_runtime.Fragment, {
    children: /*#__PURE__*/jsx_runtime.jsx(layout/* default */.Z, {
      home: true,
      children: /*#__PURE__*/jsx_runtime.jsx(homebox, {
        maxId: maxId,
...
const getServerSideProps = modules/* default.getServerSideProps */.Z.getServerSideProps(store => async ctx => {
  const max = await lib_prisma.user.aggregate({
    _max: {
      id: true
    }
  });
  const maxId = await max._max.id;
  const noticesJSON = await lib_prisma.post.findMany({
    where: {
      type: 'notice'
    },
    take: -1
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      const compMod = __webpack_require__(67099)
...
// Exports
module.exports = {
	"container": "homebox_container__9eGFA",
	"introduce": "homebox_introduce__3Svch",
	"infos": "homebox_infos__1pgsm",
	"f1": "homebox_f1__JoezE"
};
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [580,994,572,872,84,130,795,930,874,209,752], () => (__webpack_require__(71164)))
