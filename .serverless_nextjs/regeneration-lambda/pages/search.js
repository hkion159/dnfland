...
function CharImg(props) {
  ...
  return /*#__PURE__*/jsx_runtime.jsx(next_image.default, {
    alt: "character",
...
async function getCharacters(charName, {
  ...
  switch (scope) {
    case 'character':
      ...
      const res = await axios_default().get(`${getBaseUrl()}/servers/all/characters?characterName=${searchKey}&wordType=${wordType}&limit=200&apikey=${getAPIKey()}`);
...
async function getSkillStyles(character) {
  ...
  const res = await axios_default().get(`${getBaseUrl()}/servers/${serverId}/characters/${charId}/skill/style?apikey=${getAPIKey()}`);
  const skills = res.data['skill']['style'];
  return skills;
}
;// CONCATENATED MODULE: ./components/profile/thumbnail.js
...
function Thumbnail({
  ...
  return /*#__PURE__*/jsx_runtime.jsx("div", {
    className: `border border-secondary rounded-3 p-0 ${(thumbnail_module_default()).box}`,
    children: /*#__PURE__*/jsx_runtime.jsx(next_link.default, {
      href: `/character?characterid=${charId}`,
      as: "/character",
      children: /*#__PURE__*/(0,jsx_runtime.jsxs)("a", {
        children: [/*#__PURE__*/jsx_runtime.jsx("div", {
          children: /*#__PURE__*/jsx_runtime.jsx(CharImg, {
            character: character
          })
        }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          className: "d-flex border-top",
          children: [/*#__PURE__*/jsx_runtime.jsx("div", {
            className: "px-2 border-end text-secondary",
            children: serverName
          }), /*#__PURE__*/jsx_runtime.jsx("div", {
            className: `px-2 ${(thumbnail_module_default()).name}`,
          ...
          className: "d-flex border-top",
          children: [/*#__PURE__*/jsx_runtime.jsx("div", {
            className: `px-2 border-end ${positionColor[position]}`,
            children: position.toUpperCase()
          }), /*#__PURE__*/jsx_runtime.jsx("div", {
            className: `px-2 text-dark ${(thumbnail_module_default()).align}`,
            children: job
          })]
        }), /*#__PURE__*/jsx_runtime.jsx("div", {
          className: "px-2 border-top text-center text-secondary",
          children: getDamage(character)
        })]
      })
    })
  });
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    children: [/*#__PURE__*/jsx_runtime.jsx("div", {
      ...
      children: /*#__PURE__*/jsx_runtime.jsx("h5", {
        ...
        children: charsArr.length ? `닉네임 '${name}' 검색 결과는 ${charsArr.length}캐릭터입니다.` : `닉네임 '${name}' 검색 결과가 없습니다.`
      })
    }), /*#__PURE__*/jsx_runtime.jsx("div", {
...
async function getPosition(character) {
  ...
  for (let jobClass of jobTable) {
    ...
    for (let job of jobs) {
      var _job$next$next$next;

      const growNameList = [job.jobGrowName, job.next.jobGrowName, job.next.next.jobGrowName, (_job$next$next$next = job.next.next.next) === null || _job$next$next$next === void 0 ? void 0 : _job$next$next$next.jobGrowName];
...
const getServerSideProps = modules/* default.getServerSideProps */.Z.getServerSideProps(store => async ctx => {
  ...
  const chars = []; // 배열 내 객체에 대해 비동기 실행을 위한 부분
  ...
  async function process() {
    for (const character of charsArr) {
      ...
      const newCharacter = await _objectSpread(_objectSpread({}, character), {}, {
...
// Exports
module.exports = {
	"result": "searchbox_result__3K9-o"
};
...
// Exports
module.exports = {
	"box": "thumbnail_box__21cpC",
	"name": "thumbnail_name__3jb2L",
	"align": "thumbnail_align__1SvkF"
};
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [580,994,572,872,84,130,675,158,664,388,874,209,752], () => (__webpack_require__(70193)))
