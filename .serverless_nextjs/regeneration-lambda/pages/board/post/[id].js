...
;// CONCATENATED MODULE: ./pages/board/post/[id].js
...
const PostViewer = (0,dynamic.default)(() => Promise.all(/* import() */[__webpack_require__.e(893), __webpack_require__.e(817)]).then(__webpack_require__.bind(__webpack_require__, 16817)), {
  ssr: false,
  loadableGenerated: {
    webpack: () => [/*require.resolve*/(16817)],
    modules: ["board\\post\\[id].js -> " + '../../../components/common/postviewer']
  }
});
  ...
  return /*#__PURE__*/jsx_runtime.jsx(layout/* default */.Z, {
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/jsx_runtime.jsx("p", {
        className: "my-4",
        children: post.type === 'notice' ? '공지사항' : '일반게시글'
      }), /*#__PURE__*/jsx_runtime.jsx("h3", {
        className: "d-inline-block",
        children: post.title
      }), /*#__PURE__*/jsx_runtime.jsx("p", {
        className: "me-3",
        children: `작성자id: ${post.authorId}`
      }), /*#__PURE__*/jsx_runtime.jsx("p", {
        children: `작성 시간: ${getDateTime(post.postDate)}`
      }), post.reviseDate && /*#__PURE__*/jsx_runtime.jsx("p", {
        children: `마지막 수정 시간: ${getDateTime(post.reviseDate)}`
      }), /*#__PURE__*/jsx_runtime.jsx("hr", {}), /*#__PURE__*/jsx_runtime.jsx(PostViewer, {
...
const getServerSideProps = modules/* default.getServerSideProps */.Z.getServerSideProps(store => async ctx => {
  const post = await lib_prisma.post.findUnique({
    where: {
...
/* harmony default export */ const _id_ = (Board);
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      const compMod = __webpack_require__(88129)
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [580,994,572,872,280,176,130,930,795,152,874,209,752], () => (__webpack_require__(9564)))
