...
var index = require('./index-953fd6b7.js');
require('./regeneration-handler-410de241.js');
require('stream');
require('zlib');
require('http');
...
var getArnResources = function (resource) {
    ...
    var _a = index.__read(resource.split(delimiter)), resourceType = _a[0], rest = _a.slice(1);
    if (resourceType === "accesspoint") {
        ...
        var _b = index.__read(rest, 3), outpostId = _b[0]; _b[1]; var accesspointName = _b[2];
...
var getEndpointFromBucketName = function (_a) {
    ...
    var _g = index.__read(isCustomEndpoint ? [region, baseHostname] : getSuffix(baseHostname), 2), clientRegion = _g[0], hostnameSuffix = _g[1];
...
var getEndpointFromArn = function (options) {
    ...
    if (service === "s3-object-lambda") {
        return getEndpointFromObjectLambdaArn(index.__assign(index.__assign({}, options), { tlsCompatible: tlsCompatible, bucketName: bucketName, accesspointName: accesspointName, hostnameSuffix: hostnameSuffix }));
    }
    if (region === "") {
        return getEndpointFromMRAPArn(index.__assign(index.__assign({}, options), { clientRegion: clientRegion, mrapAlias: accesspointName, hostnameSuffix: hostnameSuffix }));
    }
    if (outpostId) {
        return getEndpointFromOutpostArn(index.__assign(index.__assign({}, options), { clientRegion: clientRegion, outpostId: outpostId, accesspointName: accesspointName, hostnameSuffix: hostnameSuffix }));
    }
    return getEndpointFromAccessPointArn(index.__assign(index.__assign({}, options), { clientRegion: clientRegion, accesspointName: accesspointName, hostnameSuffix: hostnameSuffix }));
};
...
var bucketEndpointMiddleware = function (options) { return function (next, context) { return function (args) { return index.__awaiter(void 0, void 0, void 0, function () {
    ...
    return index.__generator(this, function (_j) {
        switch (_j.label) {
            case 0:
                ...
                if (!index.HttpRequest.isInstance(request)) return [3 /*break*/, 9];
                if (!options.bucketEndpoint) return [3 /*break*/, 1];
                request.hostname = bucketName;
                return [3 /*break*/, 8];
            case 1:
                if (!index.validate(bucketName)) return [3 /*break*/, 6];
            ...
            case 8:
                ...
                _j.label = 9;
            case 9: return [2 /*return*/, next(index.__assign(index.__assign({}, args), { request: request }))];
        }
    });
}); }; }; };
...
const serializeAws_restXmlPutObjectCommand = async (input, context) => {
    ...
    const headers = {
        ...
        ...(isSerializableHeaderValue(input.Expires) && { expires: index.dateToUtcString(input.Expires).toString() }),
...
const deserializeAws_restXmlPutObjectCommand = async (output, context) => {
    ...
    if (output.headers["x-amz-server-side-encryption-bucket-key-enabled"] !== undefined) {
        contents.BucketKeyEnabled = index.parseBoolean(output.headers["x-amz-server-side-encryption-bucket-key-enabled"]);
    }
    ...
    return function (next) {
        return function (args) { return index.__awaiter(_this, void 0, void 0, function () {
            ...
            return index.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        input = index.__assign({}, args.input);
                        properties = [
                            {
                    ...
                    case 1:
                        ...
                        properties_1 = index.__values(properties), properties_1_1 = properties_1.next();
                        _g.label = 2;
                    case 2:
                        ...
                        _a = [index.__assign({}, input)];
                        _f = {}, _f[prop.target] = encoded;
                        _b = prop.hash;
                        _d = (_c = options).base64Encoder;
                        return [4 /*yield*/, hash.digest()];
                    case 3:
                        input = index.__assign.apply(void 0, _a.concat([(_f[_b] = _d.apply(_c, [_g.sent()]), _f)]));
                        _g.label = 4;
                    case 4:
                    ...
                    case 7:
                        ...
                        return [7 /*endfinally*/];
                    case 8: return [2 /*return*/, next(index.__assign(index.__assign({}, args), { input: input }))];
                }
            });
        }); };
    };
