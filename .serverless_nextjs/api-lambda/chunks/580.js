...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(27014) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13336) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13336).concat(__webpack_require__(44346)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13336).concat(__webpack_require__(44346)) },
        gb18030: function() { return __webpack_require__(36258) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(77348) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(74284).concat(__webpack_require__(63480)) },
        encodeSkipVals: [
...
var _head = _interopRequireDefault(__webpack_require__(70639));
...
var querystring = _interopRequireWildcard(__webpack_require__(39824));
...
var _querystring = __webpack_require__(39824);
...
var _parseRelativeUrl = __webpack_require__(57658);
...
var _parseUrl = __webpack_require__(16101);
...
var _formatUrl = __webpack_require__(82065);
...
var _normalizeLocalePath = __webpack_require__(88820);
var _pathMatch = _interopRequireDefault(__webpack_require__(10920));
var _routeRegex = __webpack_require__(66979);
var _routeMatcher = __webpack_require__(73990);
var _prepareDestination = _interopRequireWildcard(__webpack_require__(66465));
var _accept = _interopRequireDefault(__webpack_require__(73544));
var _detectLocaleCookie = __webpack_require__(71322);
var _detectDomainLocale = __webpack_require__(29269);
...
var _loadComponents = __webpack_require__(42610);
...
async function loadDefaultErrorComponents(distDir) {
    const Document1 = interopDefault(__webpack_require__(88881));
    const App = interopDefault(__webpack_require__(93857));
    ...
    return {
        ...
        Document: Document1,
        Component,
        buildManifest: __webpack_require__(59521)((0, _path).join(distDir, `fallback-${_constants.BUILD_MANIFEST}`)),
...
async function loadComponents(distDir, pathname, serverless) {
    ...
    const [buildManifest, reactLoadableManifest, Component, Document1, App] = await Promise.all([
        __webpack_require__(59521)((0, _path).join(distDir, _constants.BUILD_MANIFEST)),
        __webpack_require__(59521)((0, _path).join(distDir, _constants.REACT_LOADABLE_MANIFEST)),
...
function getPagePath(page, distDir, serverless, dev, locales) {
    ...
    const pagesManifest = __webpack_require__(59521)((0, _path).join(serverBuildPath, _constants.PAGES_MANIFEST));
    try {
...
function requirePage(page, distDir, serverless) {
    ...
    return __webpack_require__(59521)(pagePath);
}
function requireFontManifest(distDir, serverless) {
    ...
    const fontManifest = __webpack_require__(59521)((0, _path).join(serverBuildPath, _constants.FONT_MANIFEST));
    return fontManifest;
}
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(87051) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
        encodeSkipVals: [{from: 0xED40, to: 0xF940}],
    },
    'csshiftjis': 'shiftjis',
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(10418) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(82190) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(82190).concat(__webpack_require__(30853)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(86650) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(17768) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(17768).concat(__webpack_require__(48073)) },
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(44823)(iconv);
    }
